...
-----------------------------------------------------------------------
  ...
  1 new special moves and 2 new super moves
...
-----------------------------------------------------------------------
  ...
  HCB="  " "    " back
	...
	Extra Moves
		...
		Super:
                        No Contest  = QCFQCF + a 
                        Luna Ring Earth  Shower = QCFQCF + b
                        Luna Ring Heaven Shower = QCFQCF + b  (in air)

	Rage Explosion = x + y + a
	Rage Explosion Attack = x + y + a (After Rage Explosion)

	Master Slash Combo Attacks
	Master Slash Starter = z
        Combo 1         holdfwd + x,x,x
        Combo 2            "    + x,x,y,a
        Combo 3            "    + x,x,y,b
        Combo 4            "    + x,x,y,y,y
        Master Arts        "    + x,x,y,y,a,a,x,y,a,a,a,a,a,a                    
