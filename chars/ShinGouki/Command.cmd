...
trigger3= (stateno=1100 || stateno=1305 || stateno=1505) && movecontact
...
trigger1= ctrl || ((stateno=[200,299]) && time<=2) || (stateno=200||stateno=230||stateno=245)
trigger2= (stateno=[200,255]) && stateno!=207 && movecontact
trigger3= (stateno=1100 || stateno=1305 || stateno=1505 || stateno=3300) && movecontact
...
trigger9= stateno=52 && (prevstateno=[1000,4999]) && movecontact
...
trigger3= var(20) && (stateno=[200,289]) && movecontact
...
trigger1= ctrl
trigger2= (stateno=200 || stateno=215 || stateno=230 || stateno=245) && (movecontact=[1,4])
trigger3= var(20) && (stateno=[200,289]) && movecontact
trigger4= var(20) && (stateno=[1000,2999]) && statetype!=A && movecontact
trigger5= var(20) && (stateno=[1000,2999]) && statetype!=A && numhelper(stateno+5)
trigger5= helper(stateno+5),var(3)
...
trigger1= ctrl
trigger2= ((stateno=[200,205]) || (stateno=[230,235]) || (stateno=[215,220]) || (stateno=[245,250])) && (movecontact=[1,4])
trigger3= var(20) && (stateno=[200,289]) && movecontact
trigger4= var(20) && (stateno=[1000,2999]) && statetype!=A && movecontact
trigger5= var(20) && (stateno=[1000,2999]) && statetype!=A && numhelper(stateno+5)
trigger5= helper(stateno+5),var(3)
...
trigger4= var(20) && (stateno=[200,289]) && movecontact
...
trigger1= ctrl
trigger2= ((stateno=[200,205]) || stateno=215 || (stateno=[230,235]) || stateno=245) && (movecontact=[1,4])
trigger3= var(20) && (stateno=[200,289]) && movecontact
trigger4= var(20) && (stateno=[1000,2999]) && statetype!=A && movecontact
trigger5= var(20) && (stateno=[1000,2999]) && statetype!=A && numhelper(stateno+5)
trigger5= helper(stateno+5),var(3)
...
trigger1= ctrl
trigger2= (stateno=200 || stateno=205 || stateno=210 || (stateno=[230,240]) || (stateno=[215,220]) || (stateno=[245,250])) && (movecontact=[1,4])
trigger3= var(20) && (stateno=[200,289]) && movecontact
trigger4= var(20) && (stateno=[1000,2999]) && statetype!=A && movecontact
trigger5= var(20) && (stateno=[1000,2999]) && statetype!=A && numhelper(stateno+5)
trigger5= helper(stateno+5),var(3)
...
trigger1= ctrl
trigger2= var(20) && (stateno=[200,289]) && movecontact
...
trigger1= ctrl
trigger2= stateno=260 && (movecontact=[1,4]) && var(9)!=2
trigger3= var(20) && (stateno=[200,289]) && movecontact
trigger4= var(20) && (stateno=[1000,2999]) && statetype!=A && movecontact
trigger5= var(20) && (stateno=[1000,2999]) && statetype!=A && numhelper(stateno+5)
trigger5= helper(stateno+5),var(3)
...
trigger1= ctrl
trigger2= (stateno=[260,280]) && (movecontact=[1,4]) && var(9)!=2
trigger3= var(20) && (stateno=[200,289]) && movecontact
trigger4= var(20) && (stateno=[1000,2999]) && statetype!=A && movecontact
trigger5= var(20) && (stateno=[1000,2999]) && statetype!=A && numhelper(stateno+5)
trigger5= helper(stateno+5),var(3)
...
trigger1= stateno=240 && (movecontact=[1,4]) && var(20)>0
...
[State -1, roll/dodge]
type=changestate
value=ifelse(random<250,710,720)
trigger1= var(59)>=1 && numenemy
trigger1= roundstate=2 && statetype!=A
...
trigger1= (p2bodydist x=[0,20]) && (p2dist y=[-80,-40]) && random<333
...
trigger2= (stateno=260 || stateno=265 || stateno=275 || stateno=280) && var(9)!=2 && (movehit=[1,4]) && random<250
...
trigger1= ctrl && random<25
trigger2= stateno=1050 && animelemtime(3)>=2 && random<50
...
trigger2= stateno=1400 && animelemtime(6)>=0 && (p2bodydist x=[0,50]) && p2statetype!=A && random<250
...
trigger1= stateno=3300 && movehit && random<50
