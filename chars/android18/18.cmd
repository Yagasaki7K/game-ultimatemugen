...
[Command]
name = "Hyper2"     ;Required (do not remove)
...
[Command]
name = "Hyper3"     ;Required (do not remove)
command = ~D,DB,B,F,y
time = 20


[Command]
name = "Hyper4"     ;Required (do not remove)
command = ~D,DF,F,D,DF,F,y
time = 25

[Command]
name = "Hyper5"     ;Required (do not remove)
command = ~B, DB, D, DF, F, y
time = 20


[Command]
name = "l33t"     ;Required (do not remove)
command = ~D,DF,F, x+y
...
[Command]
name = "BFx"     ;Required (do not remove)
command = ~B, F, x
time = 10

[Command]
name = "BFy"     ;Required (do not remove)
command = ~B, F, y
time = 10

[Command]
name = "BFz"     ;Required (do not remove)
command = ~B, F, z
time = 10

[Command]
name = "FBFx"     ;Required (do not remove)
command = ~F, B, F, x

[Command]
name = "FBFy"     ;Required (do not remove)
command = ~F, B, F, y

[Command]
name = "FBFz"     ;Required (do not remove)
command = ~F, B, F, z

[Command]
name = "FBFa"     ;Required (do not remove)
command = ~F, B, F, a

[Command]
name = "FBFb"     ;Required (do not remove)
command = ~F, B, F, b

[Command]
name = "FBFc"     ;Required (do not remove)
command = ~F, B, F, c
...
[Command]
name = "QCBz"     ;Required (do not remove)
command = ~D, DB, B, z

[Command]
name = "BCDx"     ;Required (do not remove)
command = ~B, DB, D, x

[Command]
name = "BCDy"     ;Required (do not remove)
command = ~B, DB, D, y

[Command]
name = "BCDz"     ;Required (do not remove)
command = ~B, DB, D, z
...
[Command]
name = "FCDk"     ;Required (do not remove)
command = ~F, DF, D, a
...
[Command]
name = "DPx"     ;Required (do not remove)
command = ~F, D, DF, x

[Command]
name = "DPy"     ;Required (do not remove)
command = ~F, D, DF, y

[Command]
name = "DPz"     ;Required (do not remove)
command = ~F, D, DF, z

[Command]
name = "DPa"     ;Required (do not remove)
command = ~F, D, DF, a

[Command]
name = "DPb"     ;Required (do not remove)
command = ~F, D, DF, b

[Command]
name = "DPc"     ;Required (do not remove)
command = ~F, D, DF, c

[Command]
name = "DUa"     ;Required (do not remove)
command = ~DB, U, a

[Command]
name = "DUb"     ;Required (do not remove)
command = ~DB, U, b

[Command]
name = "DUc"     ;Required (do not remove)
command = ~DB, U, c
...
[Command]
name = "HCBa"     ;Required (do not remove)
command = ~F, DF, D, DB, B, a
time = 20

[Command]
name = "HCBb"     ;Required (do not remove)
command = ~F, DF, D, DB, B, b
time = 20

[Command]
name = "HCBc"     ;Required (do not remove)
...
;[Command]
;name = "Flying";Required (do not remove)
;command = y+b
;time = 1

[Command]
name = "Roman";Required (do not remove)
command = a+y+c
time = 1
...
value = 3000
triggerall = var(59) <= 0
triggerall = command = "Hyper1" && power >= 2000
triggerall = statetype != A
trigger1 = ctrl = 1
trigger2 = (stateno = [200,299]) || (stateno = [400,499]) 
trigger2 = movecontact
trigger3 = stateno = [300,399]
trigger3 = movecontact
trigger4 = (stateno = [1000,1049]) || (stateno = [1070,1099])
...
value = 3030
triggerall = var(59) <= 0
triggerall = command = "Hyper4" && power >= 1000
triggerall = statetype != A
trigger1 = ctrl = 1
trigger2 = (stateno = [200,299]) || (stateno = [400,499]) 
trigger2 = movecontact
...
type = ChangeState
value = 3010
triggerall = command = "Hyper2" && power >= 3000
triggerall = statetype != A
trigger1 = ctrl = 1
trigger2 = (stateno = [200,299]) || (stateno = [400,499])
trigger2 = movecontact
...
value = 3050
triggerall = statetype=A
triggerall = command = "Hyper3" && power >= 2000
trigger1 = ctrl = 1
trigger2 = stateno = [600,699]
trigger2 = movecontact
trigger3 = (stateno = [1000,1049]) || (stateno = [1070,1099])
trigger3 = movecontact
...
type = ChangeState
value = 3090
triggerall = command = "l33t" && power = 3000
triggerall = statetype != A
trigger1 = ctrl = 1
trigger2 = (stateno = [200,299]) || (stateno = [400,499]) 
trigger2 = movecontact
...
trigger2 = (stateno = [200,299]) || (stateno = [400,499]) 
trigger2 = movecontact
trigger3 = (stateno = [150,153]) && power >= 1500
...
trigger2 = movecontact
trigger3 = stateno = 902
trigger4 = (stateno = [150,155]) && power >= 1500 
trigger5 = stateno = 302
trigger5 = movecontact

;Kikkoken_X
[State -1]
type = ChangeState
value = 1002+(30*(statetype =A))
triggerall = var(59) <= 0
triggerall = !NumHelper(11000)
triggerall = power >= 100
...
;---------------------------------------------------------------------------
;Hakyoku Ken Double Fist
[State -1, Dashing Strong Punch]
type = ChangeState
value = 220
triggerall = var(59) <= 0
triggerall = command = "y"
...
trigger1 = ctrl
trigger2 = (stateno = 200) && movecontact
trigger3 = (stateno = 230) && movecontact && Anim = 231
...
trigger1 = (stateno = [200,299]) || (stateno = [400,499]) || (stateno = [300,399])
trigger1 = movehit
trigger1 = p2bodydist X < 15
trigger1 = p2bodydist Y = [0,-20]
trigger2 = (stateno = [1000,1049]) || (stateno = [1070,1099])
trigger2 = movehit
...
trigger2 = random = [400,419]
trigger2 = p2statetype != L
trigger2 = p2movetype != H
trigger3 = stateno = 325   || stateno = 320
...
trigger2 = prevstateno = [220,240]
trigger2 = movehit
trigger2 = var(58) = [0,29]
trigger3 = stateno = 302
trigger3 = prevstateno = 301
trigger3 = movehit
trigger3 = var(58) = [0,29]
...
trigger5 = (stateno = [1000,1049]) || (stateno = [1070,1099])
trigger5 = movehit
...
[State -1, rising buster ]
type = ChangeState
value = 1010
triggerall = var(59) = 1
triggerall = ctrl
triggerall = statetype != A
trigger1 = p2bodydist X < 20 && p2bodydist Y < -5
trigger1 = p2statetype = A && vel Y > 0
trigger1 = var(58) = 70

[State -1, rising buster2]
type = ChangeState
value = 1011
triggerall = var(59) = 1
triggerall = ctrl
triggerall = statetype != A
trigger1 = p2bodydist X < 60 && p2bodydist Y < -55
trigger1 = p2statetype = A && vel Y > 0
trigger1 = var(58) = 80
trigger2 = p2bodydist X < 30
trigger2 = random = [400,499]
trigger2 = p2statetype != L
trigger2 = p2movetype != H
trigger3 = stateno = 325   || stateno = 320
trigger3 = prevstateno = 220
...
trigger2 = prevstateno = [220,240]
trigger2 = movehit
trigger2 = var(58) = [0,20]
trigger3 = stateno = 302
trigger3 = prevstateno = 301
trigger3 = movehit
trigger3 = var(58) = [0,20]
trigger4 = stateno = 420
trigger4 = prevstateno = 400
trigger4 = movehit
trigger4 = var(58) = [0,20]
...
trigger1 = ctrl
trigger1 = p2bodydist X > 150
trigger1 = var(58) = [83,85]
trigger2 = stateno = 250
trigger2 = prevstateno = [220,240]
trigger2 = movehit
trigger2 = var(58) = [21,40]
trigger3 = stateno = 302
trigger3 = prevstateno = 301
trigger3 = movehit
trigger3 = var(58) = [21,40]
trigger4 = stateno = 420
trigger4 = prevstateno = 400
trigger4 = movehit
trigger4 = var(58) = [21,40]
...
trigger2 = prevstateno = [220,240]
trigger2 = movehit
trigger2 = var(58) = [41,60]
trigger3 = stateno = 302
trigger3 = prevstateno = 301
trigger3 = movehit
trigger3 = var(58) = [41,60]
trigger4 = stateno = 420
trigger4 = prevstateno = 400
trigger4 = movehit
trigger4 = var(58) = [41,60]
...
trigger1 = stateno = 210
trigger1 = movecontact
trigger1 = var(58) = [70,89]
trigger2 = stateno = 240
trigger2 = movecontact
trigger2 = var(58) = [70,89]
