...
trigger1 = P2BodyDist X <= 150 && Random <= 600
;---------------------------------------------------------------------------
;9 AI estrela pequena
[State -1]
type = ChangeState
value = 1000
trigger1 = RoundState = 2 && Var(59) != 0
trigger1 = Ctrl && StateType = S
trigger1 = P2BodyDist X <= 160 && Random <= 600
;---------------------------------------------------------------------------
;10 AI kunai z
[State -1]
type = ChangeState
...
trigger1 = RoundState = 2 && Var(59) != 0
trigger1 = Ctrl && StateType = S
trigger1 = P2BodyDist X <= 105 && Random <= 600
;---------------------------------------------------------------------------
;11 AI super taijutsu
[State -1]
type = ChangeState
value = 1014
trigger1 = RoundState = 2 && Var(59) != 0
...
;---------------------------------------------------------------------------
;12 AI super taijutsu
[State -1]
type = ChangeState
value = 1016
trigger1 = RoundState = 2 && Var(59) != 0
trigger1 = Ctrl && StateType = S
trigger1 = P2BodyDist X <= 98 && Random <= 600
;---------------------------------------------------------------------------
;13 AI selo nivel 3
[State -1]
type = ChangeState
...
value = 1250
trigger1 = RoundState = 2 && Var(59) != 0
trigger1 = P2BodyDist X <= 173 && Random <= 600
trigger1 = Ctrl && statetype != A
;---------------------------------------------------------------------------
;20 gatu
[State -1]
...
trigger1 = RoundState = 2 && Var(59) != 0
trigger1 = Ctrl && StateType = S
trigger1 = P2BodyDist X <= 103 && Random <= 700
;---------------------------------------------------------------------------
;21 AI super chute c
[State -1]
type = ChangeState
value = 1060
trigger1 = RoundState = 2 && Var(59) != 0
trigger1 = Ctrl && StateType = S && Random <= 500
;----------------------------------------------------------------------------
