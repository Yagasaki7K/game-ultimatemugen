...
;Lightning Inferno Near
[Command]
name = "QCF_a"
command = ~D, DF, F, a

;Lightning Inferno Mid
[Command]
name = "QCF_b"
command = ~D, DF, F, b

;Lightning Inferno Far
[Command]
name = "QCF_c"
command = ~D, DF, F, c
...
[State -1, Reset Minion]
type = VarSet
triggerall = movehit
trigger1 = stateno != 220 && stateno != 320 && stateno != 420
trigger1 = stateno != 520 && stateno != 620 && stateno != 720
var(38) = 1
...
type = ChangeState
value = 320
triggerall = var(59) && !NumHelper(6220)
triggerall = statetype != A
...
triggerall = statetype != A
triggerall = p2bodydist X = [0,80]
triggerall =  -100 <= p2bodydist y <= -70+var(7)
;triggerall = p2bodydist y = [-5,5]
trigger1 = p2movetype != A
trigger1 = p2statetype != L && ctrl  && random < 200 ;&& p2movetype = H
trigger2 = var(17) = 1 && random < 100
...
triggerall = p2bodydist Y = [-5,5]
;triggerall =  -75 <= p2bodydist y <= -75+var(7)
triggerall = random < 100-50*(prevstateno = 1270)
trigger1 = ctrl
trigger2 = var(17) = 3
trigger3 = var(9)
...
triggerall = random < 100-50*(prevstateno = 1280)
trigger1 = ctrl
trigger2 = var(17) = 3
trigger3 = var(9)

;---------------------------------------------------------------------------
[State -1, Dark Thunder Far]
type = ChangeState
value = 1290
triggerall = var(59)
triggerall = statetype != A
...
triggerall = p2bodydist X > 120
triggerall = p2bodydist Y > -340
triggerall = p2bodydist Y/p2bodydist X = [-1.7,-0.8]
;triggerall =  -75 <= p2bodydist y <= -75+var(7)
triggerall = random < 100-50*(prevstateno = 1290)
trigger1 = ctrl
trigger2 = var(17) = 3
trigger3 = var(9)
...
[State -1, Inferno]
type = ChangeState
value = (1450+30*(random < 300))+10*(p2bodydist x = [100,170]) + 20*(p2bodydist x = [171,270])
triggerall = var(59) && NumHelper(21451) = 0
triggerall = statetype != A
triggerall = p2statetype != L
...
triggerall = power >= 1000
triggerall = statetype = A
triggerall = p2bodydist X = [100,270]
triggerall =  p2bodydist y = [50,240]
triggerall = random < 100; + 100*(enemynear,movetype, = H)
triggerall = p2statetype != L && p2stateno != 5120
trigger1 = ctrl
trigger2 = random < (var(17)*100)
...
trigger1 = var(8) = [-65,35] ;&& p2statetype = A
trigger1 = random < 400
...
trigger1 = statetype = A && ctrl && random < 300
trigger1 = var(8) = [-50,35+40*(p2statetype != A)]
...
value = 3040
triggerall = !var(59) && BackEdgeDist >= 0
triggerall = command = "Judgment Day"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
value = 3080
triggerall = !var(59) && BackEdgeDist >= 0
triggerall = command = "Heart of Darkness"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
;---------------------------------------------------------------------------
[State -1, Lightning Inferno Near]
type = ChangeState
value = 1510
triggerall = !var(59) && NumHelper(21451) = 0
