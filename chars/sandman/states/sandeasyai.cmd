...
[State -1, 13]
type = ChangeState
trigger1 = var(59)>=1 && ctrl && (stateno !=[120,155]) 
trigger1 = inguarddist && (enemynear,hitdefattr =SCA,AA,AP)
value = 120
...
[State -1,15]
type = ChangeState
trigger1 = Var(59)>=1 && (stateno = [150,155]) && (random<50)
value = IfElse(StateType = S ,6300,IfElse(StateType = C ,6310,6320))

[State -1,16]
type = ChangeState
triggerall = Var(59)>=1&& roundstate=2 && alive && (stateno = 5100)
trigger1 = (random < 50) && (p2bodydist x=[-20,20])
value = 6500

[State -1, 17]
type = ChangeState
triggerall = Var(59)>=1 &&(stateno!=100) && (StateType = S) && (Random < 40)
trigger1 = (p2bodydist X >= 10) && Ctrl && (p2movetype!=A)
value = 100

[State -1, 18]
type = ChangeState
triggerall = Var(59)>=1 && (StateType != A) && Ctrl && (Random < 10) 
...
trigger1 = (vel y > 0) && canrecover && (random <30)
...
type = changestate
value = 1700
triggerall = statetype != A && (command="qs_f3p"||command="qs_b3p"||command="qs_f3k"||command="qs_b3k")
trigger1 = ctrl
...
type = ChangeState
value = 3300
triggerall = command = "head" && power >= 1000 && statetype !=A
trigger1 = ctrl
...
type = ChangeState
value = 3200
triggerall =  command = "quicksand" && power >= 1000 && statetype !=A
trigger1 = ctrl
trigger2 = (stateno = [200,250]) || (stateno = [400,450]) ||(stateno = [1000,1002])
trigger3 = stateno =1200 && p2stateno=1221 && Numhelper(1210)
...
type = ChangeState
value = 3100
triggerall = command = "sandhypergrab" && power >= 1000 && statetype !=A
trigger1 = ctrl
trigger2 = (stateno = [200,250]) || (stateno = [400,450]) ||(stateno = [1000,1002])
trigger3 = stateno =1200 && p2stateno=1221 && Numhelper(1210)
...
type = ChangeState
value = 3000
triggerall =  command = "sandsaw" && power >= 1000 && statetype !=A
trigger1 = ctrl
...
type = ChangeState
value = 1001
triggerall = statetype != A && command = "smash_down1"
trigger1 = ctrl
trigger2 = (stateno = [200,250]) || (stateno = [400,450]) 
...
type = ChangeState
value = 1002
triggerall =  statetype != A && command = "smash_down2"
trigger1 = ctrl
trigger2 = (stateno = [200,250]) || (stateno = [400,450]) 
...
type = ChangeState
value = 1000
triggerall = statetype != A && command = "smash_down3"
trigger1 = ctrl
trigger2 = (stateno = [200,250]) || (stateno = [400,450]) 
trigger3 = stateno =1200 && p2stateno=1221 && Numhelper(1210) ;cancel bindsand
...
type = ChangeState
value = 1100
triggerall = statetype !=A && command = "shower"
trigger1 = ctrl 
trigger2 = (stateno = [200,250]) || (stateno = [400,450])
...
triggerall = statetype !=A && command = "imobilizator"
trigger1 = ctrl 
trigger2 = (stateno = [200,250]) || (stateno = [400,450])
...
type = ChangeState
value = 1500
triggerall =  statetype != A && command = "collum_a" 
trigger1 = ctrl
...
type = ChangeState
value = 1501
triggerall = statetype != A && command = "collum_b"
trigger1 = ctrl
trigger2 = (stateno = [200,250]) || (stateno = [400,450]) ;Cancel ground moves
...
[State -1, assault step]
type = ChangeState
triggerall =  statetype != A && command = "collum_c"
trigger1 = ctrl
trigger2 = (stateno = [200,250]) || (stateno = [400,450]) ;Cancel ground moves
value = 1502
...
type = ChangeState
value = 105
triggerall = statetype = S && ctrl && stateno != 105
trigger1 = command = "BB"
