...
triggerall = var(9) = 1
triggerall = power >= 1000 && var(10) > 0
trigger1 = random <= 100 && stateno = 215 && animelemtime(6) > 0 && animelemtime(7) < 0 && movehit
trigger2 = random <= 100 && stateno = 470 && animelemtime(2) > 0 && animelemtime(3) < 0 && movehit
trigger3 = random <= 100 && stateno = 225 && animelemtime(7) > 0 && animelemtime(9) < 0 && movehit
trigger4 = random <= 100 && stateno = 703 && animelemtime(4) > 0 && animelemtime(5) < 0 && movehit
trigger5 = random <= 10 && var(42) = 1 && power >= 2000 && movehit
trigger5 = stateno = 4900 || stateno = 4910 || stateno = 4300 || stateno = 4310 || stateno = 3501 || stateno = 2110 || stateno = 2210
...
triggerall = var(9) = 1 
triggerall = power >= 1000 && var(10) > 0
trigger1 = statetype != A && (ctrl || (stateno = [0,101]) || stateno = 2080 && animelemtime(3) > 0 )
trigger1 = random <= 100 && (p2bodydist x = [40,100])  && p2statetype = A && enemynear, vel y <= 0
trigger1 = p2movetype != H  && p2bodydist y >= -90 && p2bodydist y <= -20
trigger2 = random <= 50 && stateno = 215 && animelemtime(6) > 0 && animelemtime(7) < 0 && movehit
trigger3 = random <= 100 && stateno = 470 && animelemtime(2) > 0 && animelemtime(3) < 0 && movehit
trigger4 = random <= 100 && stateno = 703 && animelemtime(4) > 0 && animelemtime(5) < 0 && movehit
trigger5 = random <= 10 && var(42) = 1 && power >= 2000 && movehit
trigger5 = stateno = 4900 || stateno = 4910 || stateno = 4300 || stateno = 4310 || stateno = 3501 || stateno = 2110 || stateno = 2210
...
trigger2 = random <= 100 && stateno = 470 && animelemtime(2) > 0 && animelemtime(3) < 0 && movehit
trigger3 = random <= 100 && stateno = 225 && animelemtime(7) > 0 && animelemtime(9) < 0 && movehit
trigger4 = random <= 200 && stateno = 703 && animelemtime(4) > 0 && animelemtime(5) < 0 && movehit
trigger5 = random <= 10 && var(42) = 1 && ifelse(var(10) > 0, power >= 1000, power >= 2000) && movehit
trigger5 = stateno = 4900 || stateno = 4910 || stateno = 4300 || stateno = 4310 || stateno = 3501 || stateno = 2110 || stateno = 2210

[State -1, HAG]
type = ChangeState
value = ifelse(random <= 500,6150,6160)
triggerall = var(9) = 1
triggerall = power >= 1000
trigger1 = random <= 100 && stateno = 215 && animelemtime(6) > 0 && animelemtime(7) < 0 && movehit
trigger2 = random <= 100 && stateno = 470 && animelemtime(2) > 0 && animelemtime(3) < 0 && movehit
...
[State -1, PG2K2]
type = ChangeState
value = ifelse(random <= 500,8150,8160)
triggerall = var(9) = 1 
triggerall = power >= 1000 
trigger1 = statetype != A && (ctrl || (stateno = [0,101]) || stateno = 2080 && animelemtime(3) > 0 )
trigger1 = random <= 100 && (p2bodydist x = [40,100])  && p2statetype = A && enemynear, vel y <= 0
trigger1 = p2movetype != H  && p2bodydist y >= -90 && p2bodydist y <= -20
trigger2 = random <= 100 && stateno = 215 && animelemtime(6) > 0 && animelemtime(7) < 0 && movehit
trigger3 = random <= 100 && stateno = 470 && animelemtime(2) > 0 && animelemtime(3) < 0 && movehit
trigger4 = random <= 200 && stateno = 703 && animelemtime(4) > 0 && animelemtime(5) < 0 && movehit
trigger5 = random <= 10 && var(42) = 1 && ifelse(var(10) > 0, power >= 1000, power >= 2000) && movehit
trigger5 = stateno = 4900 || stateno = 4910 || stateno = 4300 || stateno = 4310 || stateno = 3501 || stateno = 2110 || stateno = 2210
...
value = 4610
triggerall = var(9) = 1 && var(10) > 0
trigger1 = (stateno = 4300 || stateno = 4310) && animelemtime(6) > 1 && movecontact
...
[State -1, RisingTackle]
type = ChangeState
value = 4160
triggerall = var(9) = 1 && var(10) > 0
trigger1 = (stateno = 4953 || stateno = 4963) && animelemtime(6) > 0 && movecontact
...
trigger1 = ifelse((p2stateno = [200,999]), p2movetype != I,1)  
...
trigger1 = Random <= 100 && (p2bodydist x = [55,68]) && p2statetype != A && p2statetype != L && p2movetype != A
trigger1 = ifelse((p2stateno = [200,999]), p2movetype != I,1)  
...
triggerall = var(9) = 1
triggerall = p2bodydist x > 20
trigger1 = statetype = S && (ctrl || (stateno = [100,101])) && p2movetype != A
...
[State -1, Cshoot]
type = ChangeState
value = ifelse(p2bodydist x <= 90, 4600,4610)
triggerall = var(9) = 1
trigger1 = statetype != A && (ctrl || (stateno = [0,101]) || stateno = 2080 && animelemtime(3) > 0 )
trigger1 = random <= 300 && (p2bodydist x = [60,140])  && p2statetype = A && enemynear, vel y <= 0
trigger1 = p2movetype != H  && p2movetype != A && p2bodydist y >= -90 && p2bodydist y <= -20
...
[State -1, CRTi]
type = ChangeState
value = ifelse(random <= 500, 4150,4160)
triggerall = var(9) = 1
triggerall = statetype != A && (ctrl || (stateno = [0,101]) || stateno = 2080 && animelemtime(3) > 0)
trigger1 = random <= 700 && p2bodydist x <= 50 && p2statetype = A &&  (enemy, facing) != facing
trigger1 = p2movetype != H && p2bodydist y >= -70 && p2stateno != 5040 
trigger2 = random <= 500 && p2bodydist x <= 35 && p2statetype != A
...
triggerall = power >= 1000 || var(10) > 0
triggerall = statetype != A && (ctrl || (stateno = [0,101]) || stateno = 2080 && animelemtime(3) > 0)
trigger1 = random <= 100 && p2bodydist x <= 50 && p2statetype = A &&  (enemy, facing) != facing
trigger1 = p2movetype != H && p2bodydist y >= -70 && p2stateno != 5040 
trigger2 = random <= 500 && p2bodydist x <= 35 && p2statetype != A
trigger2 = p2movetype = A &&  (enemy, facing) != facing
...
trigger2 = random <= 300 && stateno = 440 && animelemtime(3) > 0 && animelemtime(4) < 0 && movehit
trigger3 = random <= 500 && stateno = 215 && animelemtime(6) > 0 && animelemtime(7) < 0 && moveguarded && p2statetype = S
...
triggerall = var(9) = 1 && p2statetype != A
trigger1 = random <= 400 && stateno = 215 && animelemtime(6) > 0 && animelemtime(7) < 0 && movehit
trigger2 = random <= 400 && stateno = 470 && animelemtime(2) > 0 && animelemtime(3) < 0 && movehit
trigger3 = random <= 400 && stateno = 440 && animelemtime(3) > 0 && animelemtime(4) < 0 && movehit
...
trigger3 = ifelse((p2stateno = [200,999]), p2movetype != I,1)  

[State -1, GW2K2]
type = ChangeState
value = stateno
triggerall = var(9) = 1 
trigger1 = random <= 300 && (stateno = 2110 || stateno = 2210) && moveguarded 
trigger1 = animelemtime(9) > 1 && p2bodydist x <= 55
...
triggerall = (stateno = [0,20]) && (ctrl || (stateno = [100,101]))
trigger1 = p2movetype = H && random <= 500 && (enemy, gethitvar(fall) = 1) && p2bodydist x > 50
...
trigger1 = random <= 500 && p2bodydist x >= 50 && p2movetype = H
trigger1 = p2stateno = 5100 || (p2statetype = A && p2movetype = H && (enemy, pos y = [-30,-60]))
trigger2 = random <= 300 && statetype != A && ctrl && (p2stateno = [200,500]) && p2bodydist x >= 100 && p2statetype != A

;Burn knuckle Motw || Powercharge EX
[State -1, BKMotw]
type = ChangeState
value = ifelse(random <= 500, 3800,4020)
triggerall = var(9) = 1
triggerall = (power >= 1000 || var(10) > 0)
trigger1 = random <= 900 && statetype != A && (ctrl || (stateno = [100,101])) 
trigger1 = p2movetype = A && (p2bodydist x >= 130) && p2statetype != A
trigger2 = random <= 700 && stateno = 2210 && movehit && animelemtime(9) > 2
trigger3 = random <= 200 && statetype != A && (ctrl || (stateno = [100,101])) 
trigger3 = p2movetype = A && (p2bodydist x > 50) && p2statetype != A && stateno > 1000

;Air Shoot
[State -1, Shoot]
type = ChangeState
value = ifelse(random <= 500,3600,3610)
triggerall = var(9) = 1
triggerall = (power > 1000) && (p2bodydist x = [41,80]) && p2statetype = A
triggerall = movehit && random <= 100
trigger1 = stateno = 600 && animelemtime(2) > 0
trigger2 = stateno = 610 && animelemtime(2) > 0
trigger3 = stateno = 630 && animelemtime(2) > 0
trigger4 = stateno = 640 && animelemtime(2) > 0
trigger5 = stateno = 645 && animelemtime(3) > 0
trigger6 = stateno = 650 && animelemtime(3) > 0
trigger7 = stateno = 655 && animelemtime(5) > 0 && var(16) > 0
trigger8 = stateno = 660 && animelemtime(3) > 0 && var(16) > 0

[State -1,Grab]
type = ChangeState
value = ifelse(random <= 500,300,310)
triggerall = var(9) = 1
trigger1 = var(4) <= 0 && random <= 900 
trigger1 = p2stateno != 131 && p2stateno != 130 && P2bodydist X <= 10 && p2stateno != 1302 && statetype != A && ctrl
trigger1 = p2movetype != H && p2movetype != A && p2statetype != A && p2statetype != L && p2stateno != 5120 

[State -1, JUMP]
type = ChangeState
value = 40
triggerall = var(9) = 1
triggerall = statetype != A && ctrl && frontedgebodydist > 80 && p2movetype != A
trigger1 = (p2bodydist x = [135,160]) && p2statetype != A && random <= 200 && p2movetype != H
trigger2 = (p2bodydist x = [170,180]) && p2statetype != A && random <= 500 && p2movetype != H
trigger3 = (p2bodydist x = [0,10]) && p2statetype != A  && random <= 200 && p2movetype != H
trigger4 = (p2bodydist x = [0,40]) && p2statetype = L  && random <= 500 && p2movetype = H
trigger5 =  p2statetype = A  && random <= 700 && p2movetype = H && var(16) = 1
...
trigger3 = (p2stateno = [200,999]) && p2movetype != A
...
trigger1 = statetype != A && (ctrl || (stateno = [100,101]) || (stateno = 2080 && animelemtime(3) > 0))
trigger1 = Random <= 50 && (p2bodydist x >= 170) && p2statetype != A && p2statetype != L
trigger1 = ifelse(p2movetype = A, random <= 5,1)
trigger2 = statetype != A && (ctrl || (stateno = [100,101]) || (stateno = 2080 && animelemtime(3) > 0))
trigger2 = random <= 500 && statetype != A && ctrl && p2statetype != A && (p2stateno = [200,500]) && p2bodydist x >= 100 
trigger3 = random <= 500 && (stateno = 2110 || stateno = 2210) && moveguarded && p2bodydist x > 50 
...
triggerall = var(9) = 1
triggerall = power >= 1500 && statetype != A && p2bodydist x <= 60
triggerall = stateno = 150 || stateno = 152 
trigger1 = random <= 100 && backedgebodydist <= 50
trigger2 = random <= 500 && life <= 50 && frontedgebodydist > 80
