...
triggerall = Var(59)
triggerall = movehit
trigger1 = stateno = 310 || stateno = 420 || stateno = 521
...
[State -1, Air Throw]
type = ChangeState
value = ifelse(random < 300,920,950)
triggerall = var(59)
triggerall = p2bodydist X <= 20
...
triggerall =  -160 <= p2bodydist y <= -120+var(7)
;triggerall =  -100 <= p2bodydist y <= 5
triggerall = statetype != A
trigger1 = ctrl
trigger1 = random < 400
...
triggerall =  -150 <= p2bodydist y <= -70+var(7)
;triggerall = p2bodydist y = [-5,5]
trigger1 = p2movetype != A && p2statetype != A && p2statetype != L
trigger1 = ctrl
trigger1 = random < 200
...
;triggerall =  -70 <= p2bodydist y <= -70+var(7)
triggerall = p2bodydist y = [-5,5]
trigger1 = p2statetype != L && ctrl  && random < 200 ; && p2movetype = H
trigger2 = var(17) = 1 && random < 100
trigger3 = var(17) = 2 && random < 200
trigger4 = var(17) = 3 && var(21) = var(36)
...
;---------------------------------------------------------------------------
[State -1, Plasma Beam Horizontal]
type = ChangeState
value = 1450
...
;---------------------------------------------------------------------------
[State -1, Plasma Beam Diag Up]
type = ChangeState
value = 1460
triggerall = var(59) && !NumHelper(21460)
triggerall = statetype != A
triggerall = p2statetype != L
triggerall = p2bodydist X > 100
triggerall = p2bodydist Y = [-340,-100]
...
;---------------------------------------------------------------------------
[State -1, Plasma Beam Diag Down]
type = ChangeState
value = 1470
triggerall = var(59) && !NumHelper(21470)
triggerall = statetype = A
triggerall = p2statetype != L
triggerall = p2bodydist X > 70
triggerall = p2bodydist Y = [70,340]
triggerall = p2bodydist Y/p2bodydist X = [0.7,1.3]
;triggerall =  -100 <= p2bodydist y <= -60+var(7)
triggerall = random < 100
trigger1 = ctrl
trigger2 = var(17) = 3
...
type = ChangeState
value = 1480+(StateType = A)
triggerall = var(59) && !NumHelper(21480) && (stateno != [7720,7721])
;triggerall = statetype != A
triggerall = p2statetype != L
triggerall = p2bodydist X > 100 - 50*(StateType = A)
;triggerall = p2bodydist y = [-5,5]
...
triggerall = p2bodydist X > 90
;triggerall = p2bodydist Y = [-40,5]
triggerall =  -100 <= p2bodydist y <= -90+var(7)
triggerall = random < 100
trigger1 = ctrl
trigger2 = var(17) = 3
trigger3 = var(9)
...
triggerall = p2bodydist Y = [70,370]
;triggerall =  -100 <= p2bodydist y <= -90+var(7)
triggerall = random < 100
trigger1 = ctrl
trigger2 = var(17) = 3
...
type = ChangeState
value = 3000
triggerall = enemynear,life > 300 && !NumHelper(23000) && BackEdgeDist >= 0
...
type = ChangeState
value = 3040
triggerall = enemynear,life > 300 && !NumHelper(23040) && BackEdgeDist >= 0
triggerall = Var(59) && (stateno != [3000,3500]) 
triggerall = power >= 1000
triggerall = statetype != A
triggerall = p2bodydist X = [-40,40]
triggerall =  p2bodydist y = [-130,-370]
...
type = ChangeState
value = 3120
triggerall = enemynear,life > 300 && !NumHelper(24180) && BackEdgeDist >= 0
triggerall = Var(59) && (stateno != [3000,3500]) && (stateno != [7720,7721])
triggerall = power >= 1000
;triggerall = statetype != A
triggerall = p2bodydist X = [100,320]
;triggerall =  p2bodydist y = [-130,-370]
...
trigger1 = var(8) = [-40,15] ;&& p2statetype = A
trigger1 = random < 400
...
triggerall = var(8) = [-30,25];+40*(p2statetype != A)]
;triggerall =  -90 <= p2bodydist y <= -90+var(7)
trigger1 = statetype = A && ctrl && random < 300
...
triggerall = p2bodydist X = [110,270]
...
value = 721
triggerall = var(59) && !var(54)
triggerall = var(8) = [50,350]
triggerall = p2bodydist X = [1,120]
triggerall = p2bodydist Y/p2bodydist X = [1,1.3]
;triggerall =  -40 <= p2bodydist y <= -40+var(7)
trigger1 = statetype = A && ctrl && random < 100
trigger2 = var(17) = 5 && random < 200
trigger3 = var(17) = 6 && random < 300
...
;---------------------------------------------------------------------------
[State -1, Air Strong Kick Down 2]
type = ChangeState
value = 722
triggerall = var(59) && !var(54)
triggerall = var(8) = [50,350]
...
type = ChangeState
value = 3000
triggerall = !var(59) && !NumHelper(23000) && BackEdgeDist >= 0
triggerall = command = "Electric Cage"
triggerall = power >= 1000
;triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
type = ChangeState
value = 3040
triggerall = !var(59) && !NumHelper(23040) && BackEdgeDist >= 0
triggerall = command = "Sphere Flame"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
triggerall = command = "Photon Array"
triggerall = power >= 1000
;triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
type = ChangeState
value = 3120
triggerall = !var(59) && !NumHelper(21480) && BackEdgeDist >= 0
triggerall = command = "Molecular Shield"
triggerall = power >= 1000
;triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
type = ChangeState
value = 1480+(StateType = A)
triggerall = !var(59) && !NumHelper(21480)
...
trigger2 = MoveHit
trigger2 = stateno = 310 || stateno = 420 || stateno = 521
